 ...
 * @ORM\Entity(repositoryClass="EcommerceBundle\Repository\UsersAdressesRepository")
 */
class UsersAdresses
{
    /**
    ...
    /**
     * @ORM\ManyToOne(targetEntity="UsersBundle\Entity\User", inversedBy="adresses" ,cascade={"remove"})
